...
/**
 * Servlet implementation class CompanysEditServlet
 */
@WebServlet("/companys/edit")
public class CompanysEditServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public CompanysEditServlet() {
        super();
